...
export function getActivityData(parems) {
  return request({
    url: '/functions/backStage/selectZgSchoolActivity',
    method: 'get',
    params: parems
  })
}
...
export function addNewActivity(parems) {
  return request({
    url: '/functions/backStage/addZgSchoolActivity',
    method: 'post',
    data: parems
  })
}
...
export function deleteActivityInDraft(parems) {
  return request({
    url: '/functions/backStage/deleteZgSchoolActivity',
    method: 'get',
    params: parems
  })
}
...
export function changeActivityState(parems) {
  return request({
    url: '/functions/backStage/modifyZgSchoolActivityState',
    method: 'post',
    params: parems
  })
}
